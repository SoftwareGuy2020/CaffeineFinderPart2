...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient
.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationListAdapter = new LocationListAdapter(this, R.layout.location_list_item,
                                                      mAllLocationsList);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            ActivityCompat.requestPermissions(this, new String[]
                    {Manifest.permission.ACCESS_FINE_LOCATION}, FINE_LOCATION_REQUEST_CODE);
        }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.e("Caffeine Finder", "Failed connection from Google Play Services.");
    }
    ...
    private void handleNewLocation(Location newLocation) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(myCoordinate).zoom(14.0f).build();
    ...
    public void findClosestCaffeine(View view) {
        ...
        CaffeineLocation closestCaffeieneLocation = null;
        ...
        for (CaffeineLocation caffeineLocation : mAllLocationsList) {
            ...
            if (distance < minDistance) {
                ...
                closestCaffeieneLocation = caffeineLocation;
            }
        }
        /*
        Intent detailsIntent = new Intent(this, CaffeineDetailsActivity.class);
        detailsIntent.putExtra("Closest Caffeine", closestCaffeieneLocation);
